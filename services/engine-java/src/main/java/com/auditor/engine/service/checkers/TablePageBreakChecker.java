                    ...
                    if (pageBreak) {
                        ...
                        if (!hasContinuationFlag && !captionHasContinuation) {
                            Issue issue = Issue.newBuilder()
                                    ...
                                    .setMessage("Tables that break across pages must be marked with a 'continuation' flag")
                                    .setSectionId(section.getSectionId())
                                    .setSeverity(Severity.HIGH)
                                    .setSuggestion("Add a 'continuation' flag in the table caption or properties")
