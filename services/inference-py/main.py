...
def main():
    ...
    parser.add_argument("--host", default="0.0.0.0", help="gRPC bind host")
    parser.add_argument("--port", type=int, default=50051, help="gRPC bind port")
    args = parser.parse_args()

    # 优先读取环境变量 `PY_INFERENCE_ADDR`（格式示例: inference-py:8123 或 0.0.0.0:8123 或 8123）
